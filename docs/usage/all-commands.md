...
vfox info <sdk-name>[@<version>] [options]  Show plugin info or SDK path with optional formatting
...
vfox --version                  Show the installed vfox version
vfox -v                         Alias for vfox --version
vfox -V                         Alias for vfox --version
